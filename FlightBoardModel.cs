...
namespace FlightSimulator.Model
{
        ...
        
    {
        ...
        {
            FlightBoard view = new FlightBoard();   //I know..! but THIS one doesn't acknowledge outter registrations!! 

            PropertyChanged += view.Vm_PropertyChanged; //This is the whole purpose!
        ...
        {
            var ipNum = Dns.GetHostEntry("localhost").AddressList[1];//Why not simply a string?
            TcpListener server = new TcpListener(ipNum, 5400);

            TcpClient client = default(TcpClient);  //why defualt?
